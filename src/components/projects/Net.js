    ...
    return (  
        ...
        <div className="project-page">
            ...
            <div className='text-body '>
                <h1>Natural Event Tracker (NET)</h1>
                <p>NET is a system output for System Architecture and Integration Course (TUP-T 2021).</p>
                <p><i>April 2021</i></p>
                <hr />
                <a href="https://github.com/LeslieAyacocho/API-NETRACKER"><i class="fab fa-github"></i> : https://github.com/LeslieAyacocho/API-NETRACKER</a>
            </div>
