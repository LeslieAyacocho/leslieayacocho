...
const Home = () => {
    return (
        ...
        <div class="name flex items-center justify-center">
            <span>
                <h1 className='flex items-center justify-center text-4xl md:text-5xl g:text-5xl'>LESLIE AYACOCHO</h1>
                <p className='flex items-center justify-center'>Web Developer & Designer</p>
            </span>
        </div>


        <div className='flex items-center justify-center arrow'>
        <span>
            <Link2
                activeClass="active"
                    to="about"
        ...
        <div id="about" class="about flex items-center justify-center text-xl">
            <div>
                <h1 className='flex inline-flex items-center justify-center px-5 mx-5 text-4xl md:text-5xl g:text-5xl'>Hi there! 👋</h1>
            </div>
            <div>
            <p className='flex inline-flex items-center justify-center mx-5'>Welcome to my portfolio, I'm Leslie. <br />
    ...
    <div id="web-developments" className='text-center'>
            ...
            <div id="contact" className="grid grid-cols-1 lg:grid-cols-4">
                <div className='p-3 b-left'><i class="fas fa-envelope"></i> Email: lesliejayne.ayacocho@gmail.com</div>
                <div className='p-3 b-left'><i class="fab fa-linkedin"></i> LinkedIn: <a href="https://linkedin.com/in/leslie-ayacocho">linkedin.com/in/leslie-ayacocho</a> </div>
                <div className='p-3 b-left'><i class="fab fa-github"></i> Github: <a href="https://github.com/LeslieAyacocho/">github.com/LeslieAyacocho/</a> </div>
            </div>
